...
svcc23_db_root=/data/group1/z44476r/Corpora/svcc23    # change this to your dataset folder
# svcc23_db_root=../svcc23/downloads
datadir="../svcc23/data"
...
if [ ${stage} -le -1 ] && [ ${stop_stage} -ge -1 ]; then
    ...
    ../svcc23/local/data_download.sh ${svcc23_db_root}
fi
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    ../svcc23/local/data_prep.py \
        --original-path "${svcc23_db_root}" \
        --wavdir "${svcc23_db_root}/wavs" \
        --answer_path "../svcc23/answers/answer.csv" \
        --out "${datadir}/svcc23_test.csv" \
        --resample --target-sampling-rate "${target_sampling_rate}" --target-wavdir "${svcc23_db_root}/wavs_${target_sampling_rate}"
fi
