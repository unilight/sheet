...
bc23_db_root=/data/group1/z44476r/Corpora/bc23    # change this to your dataset folder
# bc23_db_root=../bc23/downloads
datadir="../bc23/data"
...
test_sets="bc23a_test bc23b_test"
...
if [ ${stage} -le -1 ] && [ ${stop_stage} -ge -1 ]; then
    ...
    ../bc23/local/data_download.sh ${bc23_db_root}
fi
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    ../bc23/local/data_prep.py \
        --original-path "${bc23_db_root}" \
        --wavdir "${bc23_db_root}/wavs" \
        --answer_path "../bc23/answers/answer.csv" \
        --out_a "${datadir}/bc23a_test.csv" \
        --out_b "${datadir}/bc23b_test.csv" \
        --resample --target-sampling-rate "${target_sampling_rate}" --target-wavdir "${bc23_db_root}/wavs_${target_sampling_rate}"
fi
